...
class Pipeline:
    ...
    def process(self, input_video: str, output_video: str,
        ...
        renderer = CaptionRenderer(
            ...
            hook_font_scale=self.config.get('hook_font_scale', 1.0),
            hook_y_position=self.config.get('hook_y_position', None),
            hook_position=self.config.get('hook_position', 'center'),
            hook_mask_quality=self.config.get('hook_mask_quality', 'medium'),
